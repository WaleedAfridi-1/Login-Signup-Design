...
regBtn.addEventListener('click', function () {
    ...
    loginPage.style.transform = "translateX(200%)";
...
signBtn.addEventListener('click', function () {
    ...
    loginPage.style.transform = "translateX(340px)";

    regPage.style.transform = "translateX(-100%)";
    regText.style.transform = "translateX(100%)";
